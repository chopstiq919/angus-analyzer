...
BULL1_PARENTAGE_REASON: [if FAIL: one short plain sentence naming the shared ancestor only, e.g. "Shares GAR Hometown with cow — same ancestor appears at two different generational levels." No rule numbers. No lengthy explanation. Blank if PASS.]
BULL1_C: [value]
